...
myBrew=(ansible autoconf bash bash-completion brew-php-switcher colordiff coreutils cowsay findutils fortune git git-crypt grc hub mcrypt moreutils node pkg-config python python3 ssh-copy-id subversion tig tree "vim --override-system-vi --with-python3" wget zsh zsh-completions zsh-history-substring-search zsh-syntax-highlighting )
